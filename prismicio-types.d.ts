...
interface SettingsDocumentData {
  ...
  /**
   * Aboutme field in *Settings*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.aboutme
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  aboutme: prismic.LinkField;

  /**
   * Discord field in *Settings*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
...
export interface BiographySliceDefaultPrimary {
  ...
  /**
   * Phone number text field in *Biography → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: biography.primary.phone_number_text
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  phone_number_text: prismic.KeyTextField;

  /**
   * Phone number field in *Biography → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: biography.primary.phone_number
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  phone_number: prismic.LinkField;

  /**
   * Email text field in *Biography → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: biography.primary.email_text
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  email_text: prismic.KeyTextField;

  /**
   * Email field in *Biography → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: biography.primary.email
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface ContentIndexSliceDefaultPrimary {
  ...
  /**
   * FallBack Idem Image field in *ContentIndex → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.primary.fallback_idem_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  fallback_idem_image: prismic.ImageField<never>;
}
...
export interface TextBlockSliceDefaultPrimary {
  /**
   * Article field in *TextBlock → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_block.primary.article
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
